...
${OBJECTDIR}/_ext/1338900640/Stats.o: ../linear-least-squares/linear-least-squares/Stats.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1338900640/Stats.o ../linear-least-squares/linear-least-squares/Stats.cpp

${OBJECTDIR}/_ext/1338900640/main.o: ../linear-least-squares/linear-least-squares/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1338900640
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1338900640/main.o ../linear-least-squares/linear-least-squares/main.cpp
...
${OBJECTDIR}/_ext/1338900640/poly.o: ../linear-least-squares/linear-least-squares/poly.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1338900640
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1338900640/poly.o ../linear-least-squares/linear-least-squares/poly.cpp
